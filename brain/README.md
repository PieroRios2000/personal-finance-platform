...
flowchart LR
    ...
    subgraph planned["Planned"]
        RIPLEY["Banco Ripley parser"]
        PROJ["Savings-goal projection"]
        ALERT["Alerting: email / Teams"]
    end
