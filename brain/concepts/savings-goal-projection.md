...
- **Goal** — a target amount and, optionally, a date. The projection's output is the time to
...
- Currencies: goals are set in soles, some accounts are in dollars, and the project does not
  convert currencies (see the ADR).
