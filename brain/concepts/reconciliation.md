...
| Continuity | A period's closing balance is the next period's opening balance, **and every calendar month has its statement (the next one ends in the month after the previous one's)**, for the same user and account; catches missing statements | T16 |
