...
their own email through [Dex](dex.md) (T39, ADR 0034), not a shared admin password, and
see only the `user_id` they were scoped to, unless they are the owner (T41, ADR 0036).
